    ...
    return (
      <div className="flex flex-col gap-1">
        ...
        <select
          ...
          disabled={disabled}
          className={cn(
            "h-12 w-full rounded-xl border-2 bg-white px-4 py-3 text-base text-indigo transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-saffron/20 focus:border-saffron disabled:opacity-60 disabled:cursor-not-allowed",
